...
<div class="border-2 py-4 px-4 rounded border-green-400 mb-4 shadow">
    <form class="" id="form" method="POST" action="{{route('produit_status.store')}}" class="w-full">
        @csrf
        <div class="flex gap-4 my-4">
            ...
            <div class="flex-1">
                <input value="" class="is_exists border-gray-400 border-2 rounded w-full px-2 py-1" type="text" name="produit_status" id="" required>
            </div>
        </div>
        ...
        <div class="flex gap-4 my-4">
            ...
            <div class="flex-1">
                <input value="" class="border-gray-400 border-2 rounded w-full px-2 py-1" type="text" name="style" id="" required>
            </div>
        </div>
                    ...
                    $.get(
                        ...
                        function(response){
                            if(response == "1"){
                                ...
                                $('.exists_error').remove();
                                that.parent().append('<div class="exists_error text-red-500 text-xs py-1">Status Existe déjà </div>')
                                proceed = false;
                            }else{
