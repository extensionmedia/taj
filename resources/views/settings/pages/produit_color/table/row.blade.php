<tr class="hover:bg-gray-50 hover:bg-opacity-50">
    ...
    <td class="px-4 py-4 whitespace-nowrap text-right text-sm font-medium">
      <a href="{{route('produit_color.edit', ['produitColor'=>$p])}}" class="edit text-gray-600 hover:text-xl hover:text-indigo-900"><i class="far fa-edit"></i></a>
    </td>
  </tr>
