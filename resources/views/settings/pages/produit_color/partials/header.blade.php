<form id="idSearch" method="GET" action="{{route('produit_color.search')}}" class="flex items-center justify-between gap-4 py-1 my-4 bg-white bg-opacity-0">
    ...
    <div class="count text-gray-600">
        Total : @if($colors) {{ $colors->count() }} @endif
    </div>
