...
<div class="border-2 py-4 px-4 rounded border-green-400 mb-4 shadow">
    <form class="" id="form" method="POST" action="{{route('produit_color.store')}}" class="w-full">
        @csrf
        <div class="flex gap-4 my-4">
            ...
            <div class="flex-1">
                <input value="" class="is_exists border-gray-400 border-2 rounded w-full px-2 py-1" type="text" name="produit_color" id="" required>
            </div>
        </div>
