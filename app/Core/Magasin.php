...
class Magasin extends Modal{
	...
	private $columns = array(
		...
		array("column" => "magasin_name", "label"=>"MAGASIN", "style"=>"font-weight:bold"),
		array("column" => "nbr_produit", "label"=>"PRODUITS", "style"=>"min-width:130px; width:130px; text-align:center; color:#E91E63; font-size:20px"),
		array("column" => "nbr", "label"=>"USER", "style"=>"min-width:130px; width:130px; text-align:center; color:#E91E63; font-size:20px"),
