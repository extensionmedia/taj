...
class Produit_Status extends Modal{
	...
	private $columns = array(
		...
		array("column" => "produit_status", "label"=>"STATUS", "style"=>"font-weight:bold"),
	...
	private $tableName = "Produit_Status";
...
$produit_status = new Produit_Status;