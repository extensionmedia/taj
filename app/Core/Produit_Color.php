...
class Produit_Color extends Modal{
	...
	private $columns = array(
		...
		array("column" => "produit_color", "label"=>"COLOR", "style"=>"font-weight:bold"),
	...
	private $tableName = "Produit_Color";
...
$produit_color = new Produit_Color;