...
class Produit_Marque extends Modal{
	...
	private $columns = array(
		...
		array("column" => "produit_marque", "label"=>"MARQUE", "style"=>"font-weight:bold"),
	...
	private $tableName = "Produit_Marque";
...
$produit_marque = new Produit_Marque;