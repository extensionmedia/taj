...
<div class="row page_title">
	<div class="col_6-inline icon">
		<i class="fas fa-address-card"></i> Couleur
	</div>
	...
	<div class="panel-content" style="padding: 0px">
		...
		<?= ($action === "edit")? "<input class='form-element' type='hidden' id='id' value='".$id."'>" : "" ?>
			<div class="row" style="margin-bottom: 20px">
				<div class="col_12">
					<label for="produit_color">Couleur</label>
					<input class="form-element required" type="text" placeholder="Couleur" id="produit_color" value="<?= ($action === "edit")? $data["produit_color"] : "" ?>">
				</div>		
			</div>
			<div class="row" style="margin-bottom: 20px">
				<div class="col_6">
