	...
	<div class="panel-content" style="padding: 0px">
		<div class="row  <?= strtolower($table_name) ?>" style="margin-top: 25px">
			<div class="row" style="margin-bottom: 20px">
				<div class="col_6">
					<label for="produit_status">Status</label>
					<input class="form-element required" type="text" placeholder="Produit Status" id="produit_status" value="<?= ($action === "edit")? $data["produit_status"] : "" ?>">
				</div>	
			</div>
			<div class="row" style="margin-bottom: 20px">
				<div class="col_6">
