	...
	<div class="panel-content" style="padding: 0px">
		...
		<?= ($action === "edit")? "<input class='form-element' type='hidden' id='id' value='".$id."'>" : "" ?>
			<div class="row" style="margin-bottom: 20px">
				<div class="col_12">
					<label for="produit_marque">Marque</label>
					<input class="form-element required" type="text" placeholder="Marque" id="produit_marque" value="<?= ($action === "edit")? $data["produit_marque"] : "" ?>">
				</div>		
			</div>
			<div class="row" style="margin-bottom: 20px">
				<div class="col_6">
