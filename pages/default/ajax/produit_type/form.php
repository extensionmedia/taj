...
<div class="row page_title">
	<div class="col_6-inline icon">
		<i class="fas fa-address-card"></i> Produit Type
	...
	<div class="panel-content" style="padding: 0px">
		<div class="row  <?= strtolower($table_name) ?>" style="margin-top: 25px">
			<div class="row" style="margin-bottom: 20px">
				<div class="col_6">
					<label for="produit_type">Produit Type</label>
					<input class="form-element required" type="text" placeholder="Produit Type" id="produit_type" value="<?= ($action === "edit")? $data["produit_type"] : "" ?>">
				</div>	
			</div>
			<div class="row" style="margin-bottom: 20px">
				<div class="col_6">
